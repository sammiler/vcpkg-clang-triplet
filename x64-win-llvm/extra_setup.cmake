if(DEFINED CURRENT_PORT_DIR AND 
   ...
   DEFINED CMD)
    ...
    find_program(CLANG_CL_EXECUTBALE NAMES "clang-cl" "clang-cl.exe" PATHS "${POSSIBLE_LLVM_BIN_DIR}"
                                                                           ENV LLVMInstallDir
                                                                     PATH_SUFFIXES "bin"
                                                                     NO_DEFAULT_PATH)
    if(NOT DEFINED ENV{LLVMInstallDir} AND NOT DEFINED ENV{LLVMToolsVersion})
        ...
        find_program(CLANG_CL_EXECUTBALE NAMES "clang-cl" "clang-cl.exe")
    endif()
    ...
    # # Additionally the compiler needs to be the first to be found on PATH
      ...
      # cmake_path(GET CLANG_CL_EXECUTBALE FILENAME cxx_compiler_filename)
